...
// Constants
const SHEET_NAME = "All in one DSA Sheet";
const PROBLEMS_PER_PAGE = 50;
const allTopics = Object.keys(allProblemsData);
const allDifficulties = ["Easy", "Medium", "Hard"];
const allStatuses = ["Solved", "Unsolved"];

// Create a flat array of all problems with unique string IDs and initial 'solved' status
let problemIdCounter = 0;
const allProblems = Object.entries(allProblemsData).flatMap(([topic, problems], topicIndex) =>
  problems.map((problem, problemIndex) => ({
    ...problem,
    id: `${topicIndex}-${problemIndex}`,

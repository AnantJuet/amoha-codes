...
interface Problem {
  ...
  platform?: string;
  link: string;
  id: string; // String ID for backend tracking
  numericId?: number;
  solved: boolean;
}
...
function Algorithm({ darkMode = false }: { darkMode?: boolean }) {
  ...
  const handleCheckboxChange = async (problemId: string, category: string, subcategory: string): Promise<void> => {

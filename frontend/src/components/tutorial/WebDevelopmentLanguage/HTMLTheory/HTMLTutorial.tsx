...
import { tutorialData, tutorialContent, type SidebarItem } from "./HTMLData";
...
const HTMLTutorial: React.FC<HTMLTutorialProps> = ({ darkMode }) => {

  // eslint-disable-next-line react-hooks/rules-of-hooks
  const flatHrefs = useMemo(() => flattenData(tutorialData), []);
  // eslint-disable-next-line react-hooks/rules-of-hooks
  const [activeHref, setActiveHref] = useState(flatHrefs.length > 0 ? flatHrefs[0] : "html_home.asp");

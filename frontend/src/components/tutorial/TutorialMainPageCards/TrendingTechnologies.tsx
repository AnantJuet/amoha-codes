...
interface TrendingTechnologiesPageProps {
  darkMode?: boolean;
}

const ScriptingLanguagesPage = ({ darkMode = false }: TrendingTechnologiesPageProps) => {

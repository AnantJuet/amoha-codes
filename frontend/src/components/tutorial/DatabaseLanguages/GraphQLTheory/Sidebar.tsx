...
import type { SidebarItem } from "../../../../data/tutorial/DatabaseLanguages/GraphQL/graphqlData";
            ...
            <li key={item.href}>
              <button
                ...
                className={`flex items-center justify-between w-full text-left px-3 py-2 rounded-md transition-colors duration-150 ${activeHref === item.href
                    ...
                    : `${darkMode ? "hover:bg-gray-700 text-white" : "hover:bg-[#6334B9] hover:text-white text-black"}`

...
import type { SidebarItem } from "../../../../data/tutorial/DatabaseLanguages/plsqlData";
...
const Sidebar: React.FC<SidebarProps> = ({ data, activeHref, onSelect, darkMode }) => {
  ...
  return (
    <aside className={`w-64 border-r h-[calc(100vh-80px)] mt-[80px] overflow-y-auto p-4 scrollbar-hide
      ...
      <h2 className="text-xl font-bold mb-3 text-[#6334B9] dark:text-purple-300">PL/SQL Tutorial</h2>

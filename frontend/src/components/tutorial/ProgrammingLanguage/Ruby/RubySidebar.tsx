...
const RubySidebar: React.FC<SidebarProps> = ({ selected, onSelect, darkMode }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-2xl font-bold text-[#6334B9]">Ruby Tutorial</h2>
      </div>
              ...
              className={`flex items-center justify-between w-full text-left font-semibold py-2 px-3 rounded-md transition-all
                ${selected === item.component
                  ...
                  : darkMode
                    ...
                    : "text-gray-800 hover:bg-[#6334B9] hover:text-white"
                }`}
            >

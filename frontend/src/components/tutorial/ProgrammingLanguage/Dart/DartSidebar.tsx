...
const DartSidebar: React.FC<SidebarProps> = ({ selected, onSelect, darkMode }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-2xl font-bold text-[#6334B9]">Dart Tutorial</h2>
      </div>

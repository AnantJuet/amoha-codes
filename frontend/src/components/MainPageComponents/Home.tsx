...
const Home: React.FC<HomeProps> = ({ darkMode }) => {
  return (
    ...
    >
      ...
      <Link
        to="/practice"
        className="px-6 py-3 rounded-lg bg-[#6334B9] text-white hover:bg-[#5028a0] transition duration-300 text-sm sm:text-base md:text-lg font-semibold shadow-lg hover:shadow-xl mt-6 sm:mt-8 cursor-pointer"
      >
        Start Learning
      </Link>
    </div>

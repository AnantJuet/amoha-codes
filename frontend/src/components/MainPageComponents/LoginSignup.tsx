...
const LoginSignup: React.FC<LoginSignupProps> = ({ onClose, onLoginSuccess }) => {
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center p-4">
          ...
          <form onSubmit={handleFormSubmit} className="flex flex-col gap-4">
            {!isLogin && (
              <>
                <input
                  ...
                  autoComplete="off"
                  required
                  className="px-4 py-3 rounded-lg border focus:ring-2 focus:ring-[#6334B9] focus:outline-none transition duration-200"
                />
                <input
                  type="text"
                  name="lastName"
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-3 rounded-lg bg-[#6334B9] text-white hover:bg-[#5028a0] transition duration-300 transform hover:scale-105 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 border rounded-lg hover:bg-gray-100 transform hover:scale-105 cursor-pointer transition"
            >

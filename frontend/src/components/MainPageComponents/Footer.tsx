...
const Footer: React.FC<FooterProps> = ({ darkMode }) => {
  return (
    <footer
      className={`py-10 px-3 sm:px-4 md:px-6 transition-colors duration-300 ${darkMode ? "bg-gray-800 text-gray-200" : "bg-[#6334B9] text-white"
        }`}
    >
      <div className="max-w-6xl mx-auto">
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={idx}>
                  <a
                    href={link.href}
                    className={`text-white transition-colors duration-200 hover:underline ${darkMode ? "hover:text-[#6334B9]" : "hover:text-gray-200"
                      }`}
                  >
                    {link.name}
                  </a>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={idx}>
                  <a
                    href={service.href}
                    className={`transition-colors duration-200 hover:underline ${darkMode ? "hover:text-[#6334B9]" : "hover:text-gray-200"
                      }`}
                  >
                    {service.name}
                  </a>
        ...
        <div
          className={`flex flex-col sm:flex-row justify-between items-center gap-4 mt-8 pt-4 border-t ${darkMode ? "border-gray-500" : "border-white/20"
            }`}
        >
          ...
          <div className="flex justify-center space-x-4">
            ...
            >
              <FaLinkedin
                size={22}
                className={`transition-colors duration-200 ${darkMode ? "hover:text-[#6334B9]" : "hover:text-gray-200"
                  }`}
              />
            </a>
            <a
